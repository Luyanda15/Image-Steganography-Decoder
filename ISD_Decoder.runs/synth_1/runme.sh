...
HD_PWD='C:/Users/User/Documents/EEE4120F/ISD_Decoder/ISD_Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log isd_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source isd_decoder.tcl
