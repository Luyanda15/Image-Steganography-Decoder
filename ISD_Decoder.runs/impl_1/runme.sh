...
HD_PWD='C:/Users/User/Documents/EEE4120F/ISD_Decoder/ISD_Decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log isd_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source isd_decoder.tcl -notrace
